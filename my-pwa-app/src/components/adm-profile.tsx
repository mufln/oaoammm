      ...
      <DialogContent className="sm:max-w-max">
        ...
        <div className="bg-white mx-auto w-max"> 
                   <div className="flex flex-col sm:flex-row items-center">
                        <div className="rounded-full w-32 h-32 bg-indigo-100 text-indigo-600 text-5xl font-bold content-center text-center">{adminInfo.name[0]}</div>
                        <div className="ml-8">
                            ...
                            <p className="text-gray-600">Логин: {adminInfo.login}</p>
                            {/* <p className="text-gray-600">Пол: {studentInfo.sex}</p>*/}
                            <p className="text-gray-600">Телефон: {adminInfo.phone}</p> 
                            <p className="text-indigo-600 mt-2"><i className="fas fa-envelope"></i> {adminInfo.email}</p>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                        <div>
                            ...
                            <p className="font-semibold">Кафедра компьютерных наук</p> {/*это заглушка, тк такой инфы нет*/}
                        </div>
                        <div>
                            <p className="text-gray-600">Личный номер</p>
                            <p className="font-semibold">12345678</p>  {/*это заглушка, тк такой инфы нет*/}
                        </div>
                        <div>
                            <p className="text-gray-600">Должность</p>
                            <p className="font-semibold">
                              {(adminInfo.role === 0) ? ("Ректор"):("Преподаватель")}
                            </p>
                        </div>
                        <div>
                            <p className="text-gray-600">Состояние</p>
                            <p className="font-semibold text-indigo-600">Активный</p>  {/*это заглушка, тк такой инфы нет*/}
                        </div>
                    </div>
