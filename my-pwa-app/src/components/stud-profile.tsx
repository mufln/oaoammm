      ...
      <DialogContent className="sm:max-w-max">
        ...
        <div className="bg-white mx-auto w-max"> 
                   <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <div className="ml-8">
                            <button className="flex mt-4 py-2 px-auto space-x-4" onClick={() => router.push('/student/stud-profile-edit')}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                    ...
                    <hr className="my-4"/>
                    <div className=" grid grid-cols-2 text-center space-x-8 space-y-4 sm:w-full sm:flex">
                        <div>
                            <p className="text-gray-600 mt-4">Группа</p>
                            <p className="font-semibold">{studentInfo.group}</p>
                        </div>
                        <div>
                            <p className="text-gray-600">Личный номер</p>
                            <p className="font-semibold">{studentInfo.personalNumber}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-indigo-600">{studentInfo.type}</p>
                        </div>
                    </div>
        </div>
      </DialogContent>
